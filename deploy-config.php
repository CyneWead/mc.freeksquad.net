 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', '7f3guRut7gTv');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/FreekSquad/mc.freeksquad.net.git');
 ...
 */
define('TARGET_DIR', '/home/minecraft/website/');
